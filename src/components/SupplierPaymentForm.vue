...
<template>
  <div class="space-y-4">
    <div>
      <label class="block text-sm text-slate-200">Amount <span class="text-red-500">*</span></label>
      <input
    ...
    <div>
      <label class="block text-sm text-slate-200">Payment Date</label>
      <input
        v-model="paymentDate"
        type="date"
        class="mt-1 w-full rounded-md border border-[rgba(255,255,255,0.06)] px-3 py-2 text-sm outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
    ...
    <div>
      <label class="block text-sm text-slate-200">Notes</label>
      <textarea
        v-model="notes"
        rows="2"
        class="mt-1 w-full rounded-md border border-[rgba(255,255,255,0.06)] px-3 py-2 text-sm outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
